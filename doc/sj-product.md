...
#### polices (상품 정책 properties)
 ...
 price | integer | 금액. </br> (할인가격이 있는 경우, 실제가격) </br> 1. 고정가격 없는 경우, products의 regular_price - price = 실제가격. </br> 2. 고정가격 있는 경우, </br> (type=fixedPrice의 price) - (type=discountedPrice의 price) = 실제가격.
